...
<!-- FooterStart -->
<cfinclude template="/site/wet3.0/html5/includes/pied_site-site_footer-eng.html" />
<cfinclude template="/boew-wet/wet3.0/html5/includes/pied_gc-gc_footer-eng.html" />
<!-- FooterEnd -->
</footer>
</div></div></div>
