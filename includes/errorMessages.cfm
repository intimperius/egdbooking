<cfif lang eq "eng" OR (IsDefined('Session.AdminLoggedIn') AND Session.AdminLoggedIn eq true)>
	...
	<cfset language.incorrectPasswordError = "Your password may be missing, invalid or incomplete. Please try again.">
...
<cfelse>
	...
	<cfset language.incorrectPasswordError = "Votre mot de passe pourrait ne pas &ecirc;tre indiqu&eacute;, ou &ecirc;tre invalide ou incomplet. Veuillez r&eacute;essayer.">
