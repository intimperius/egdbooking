...
<input type="hidden" name="BRID" value="#Variables.BRID#" />
	...
	Company: #getBooking.companyName#<br/><br/>
		...
		<div class="form-checkbox">
			<cfif getBooking.Status EQ 'c'>
				<label for="Section1">Section 1<input type="checkbox" id="Section1" name="Section1" <cfoutput>#Variables.Section1#</cfoutput>></label>
				<label for="Section2">Section 2<input type="checkbox" id="Section2" name="Section2" <cfoutput>#Variables.Section2#</cfoutput>></label>
				<label for="Section3">Section 3<input type="checkbox" id="Section3" name="Section3" <cfoutput>#Variables.Section3#</cfoutput>></label>
			</cfif>
		</div><br/>
